...
params_dir = '../../opponent_transformer/smac/pretrained_opponents/pretrained_parameters/MMM2'
num_rmappo_models = 1
rmappo_agents = [RMAPPONet(370, 18, 64) for _ in range(num_rmappo_models)]
