import numpy as np
from opponent_transformer.envs.mpe.core import Wall, World, Agent, Landmark
from opponent_transformer.envs.mpe.scenario import BaseScenario
...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        ...
        print("Custom observation function")
        comm = []
        if agent in self.good_agents(world):
            ...
            print("Agent ", agent, " obs = ", np.concatenate([agent.state.p_vel] + [agent.state.p_pos] + entity_pos + other_pos + other_vel))
            return np.concatenate([agent.state.p_vel] + [agent.state.p_pos] + entity_pos + other_pos + other_vel)
