...
from opponent_transformer.utils.util import check, get_shape_from_obs_space, get_shape_from_act_space
...
class SeparatedOpponentReplayBuffer(object):
    ...
    def insert(self, obs, rnn_states, actions, rewards, masks, bad_masks=None, active_masks=None, available_actions=None):
...
class SeparatedReplayBuffer(object):
    ...
    def recurrent_generator(self, advantages, oppnt_obs, oppnt_actions, num_mini_batch, data_chunk_length):
        ...
        for indices in sampler:
            ...
            yield obs_batch, oppnt_obs_batch, rnn_states_batch, rnn_states_critic_batch, prev_actions_batch, actions_batch, oppnt_actions_batch, value_preds_batch, return_batch, masks_batch, active_masks_batch, old_action_log_probs_batch, adv_targ, available_actions_batch
