...
--num_env_steps 10000000 --ppo_epoch 5 --gain 1 --use_value_active_masks --use_eval --eval_episodes 32 --user_name "bhd445" \
--opponent_dir "../../opponent_transformer/envs/starcraft2/pretrained_opponents/MMM2"